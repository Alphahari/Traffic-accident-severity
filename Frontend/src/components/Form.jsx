      ...
      <form onSubmit={handleSubmit(onSubmit)} className='max-w-4xl mx-auto p-6 bg-slate-200 rounded-lg shadow-md'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          <div>
            ...
            <select {...register("Road_Surface_Conditions", { required: true })} className='block w-full border rounded-lg p-2' defaultValue="">
          ...
          <div>
            ...
            <select {...register("Road_Type", { required: true })} className='block w-full border rounded-lg p-2' defaultValue="">
          ...
          <div>
            ...
            <select {...register("Special_Conditions_at_Site", { required: true })} className='block w-full border rounded-lg p-2' defaultValue="">
          ...
          <div>
            ...
            <input
              type="number"
              {...register("Speed_limit", { required: true, min: 0 })}
              className='block w-full border rounded-lg p-2' defaultValue=""
            />
            {errors["Speed_limit"] && <span className='text-red-500'>This field is required and must be a positive number</span>}
          </div>

          {/* "Urban_or_Rural_Area */}
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-900">Urban or Rural Area</label>
            <select {...register("Urban_or_Rural_Area", { required: true })} className='block w-full border rounded-lg p-2' defaultValue="">
